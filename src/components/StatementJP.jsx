    ...
    <StatementStyle>
      <div id="statement" className="statement-content">
        ...
        <p>
          ...
          HOOD
          ANIMALはただのPFPではありません。最新のAI技術を駆使し、6051年の未来動物をデザインしています。また、このNFTは複数枚獲得し、破棄することで素晴らしい特典を受けることが可能です。また、このNFTは特別なフードコミュニティ会員でもあります。このNFTで素晴らしい仲間たちとWeb3を用いて飲食業界を改革していきたいと考えています。
        </p>
      </div>
    </StatementStyle>
  );
